...
export interface KomnouInterface extends utils.Interface {
  functions: {
    ...
    "getNFTFromAddress(address,uint256)": FunctionFragment;
...
export interface Komnou extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KomnouInterface;
